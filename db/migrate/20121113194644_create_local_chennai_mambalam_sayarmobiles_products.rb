class CreateLocalChennaiMambalamSayarmobilesProducts < ActiveRecord::Migration
...
vendor_address,latitude,longitude,city_name,branch_name,working_time,miscellaneous,vendor_sub_categories,monetization_type,subscribed_date,created_at) values('SayarMobiles','na','Good mobile shop','local','na','sayar-mobiles@gmail.com','128787509','457633344', 'mambalam, chennai-24','128.083','56.098','chennai','mambalam','9AM to 8.30PM','na',
'mobiles_lists','fixed','2012-05-14',now());
  ...
  CREATE TABLE IF NOT EXISTS local_chennai_mambalam_sayarmobiles_products (
  ...
  SQL
    ...
    execute <<-SQL
    CREATE TRIGGER t_Insert_local_chennai_mambalam_sayarmobiles_products AFTER INSERT ON local_chennai_mambalam_sayarmobiles_products
    FOR EACH ROW
    BEGIN
    ...
    SELECT vendor_id INTO v_VendorID FROM vendors_lists where vendor_name='sayarmobiles' AND branch_name='mambalam';
    ...
    execute <<-SQL
    CREATE TRIGGER t_Update_local_chennai_mambalam_sayarmobiles_products AFTER UPDATE ON local_chennai_mambalam_sayarmobiles_products
    FOR EACH ROW
    BEGIN
    ...
    SQL
    execute <<-SQL
    CREATE TRIGGER t_Delete_local_chennai_mambalam_sayarmobiles_products BEFORE DELETE ON local_chennai_mambalam_sayarmobiles_products
    FOR EACH ROW
    BEGIN
  ...
  def down
        ...
        execute "call p_drop_local_vendor('sayarmobiles','chennai','mambalam')"
        execute "DROP TRIGGER t_Delete_local_chennai_mambalam_sayarmobiles_products"
        execute "DROP TRIGGER t_Update_local_chennai_mambalam_sayarmobiles_products"
        execute "DROP TRIGGER t_Insert_local_chennai_mambalam_sayarmobiles_products"
        execute "DROP TABLE local_chennai_mambalam_sayarmobiles_products"
        system "rails destroy model local_chennai_mambalam_sayarmobiles_products"
  end
end
